 ...
 * @since 20/03/2025
 */
public class Lab8ExerciseRunner {
	
	final Lab8TestFrameConfig config;
	...
	public Lab8ExerciseRunner(Lab8TestFrameConfig config) {
	...
	public static void main(String [] args) {
		...
		new Lab8ExerciseRunner(new Lab8TestFrameConfig()).runTests();
	}
}
